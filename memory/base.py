...
class BaseMemory(BaseModel):
  ...
  def similarity_search_by_vector(
    ...
    **kwargs: Any,
    ...
    return self.vector_store.similarity_search_by_vector(embedding, k=k, **kwargs)
  ...
  def max_marginal_relevance_search_by_vector(
    ...
    **kwargs: Any,
    ...
    return self.vector_store.max_marginal_relevance_search_by_vector(embedding, k=k, fetch_k=fetch_k, lambda_mult=lambda_mult, **kwargs)
  ...
  def max_marginal_relevance_search(
    ...
    **kwargs: Any,
    ...
    return self.vector_store.max_marginal_relevance_search(query, k=k, fetch_k=fetch_k, lambda_mult=lambda_mult, **kwargs)
